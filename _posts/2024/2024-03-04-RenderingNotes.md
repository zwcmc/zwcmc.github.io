...
- [(3) 通过一个四元数存储基础法线向量 `(0,0,1)` 、基础切线向量 `(1,0,0)` 与基础副切线向量 `(0,1,0)` 的旋转信息](#3-通过一个四元数存储基础法线向量-001-基础切线向量-100-与基础副切线向量-010-的旋转信息)
...
## (3) 通过一个四元数存储基础法线向量 `(0,0,1)` 、基础切线向量 `(1,0,0)` 与基础副切线向量 `(0,1,0)` 的旋转信息
