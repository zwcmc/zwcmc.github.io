...
<!-- ## (5) 在半球面上均匀采样和 $\cos$ 加权采样

### 5.1 球面坐标系与笛卡尔坐标系

在半球面上均匀采样时，使用的是 **球面坐标系** ，球面坐标系中的每个点使用 2 个角度来表示，分别是 **方位角（ $\phi$ ）** 和 **极角（ $\theta$ ）** ，其中 

球面坐标系示意图如下：

![08_spherical_coordinates](/assets/images/2024/2024-03-04-RenderingNotes/08_spherical_coordinates.png) -->
