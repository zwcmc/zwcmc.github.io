...
#### **基于斜率的深度偏移（Slope-Scale Depth Bias）**
...
#### **计算适合的光源投影的近平面和远平面（Calculating the Near Plane and Far Plane）**
...
#### **以纹素大小的增量来移动光源（Moving the Light in Texel-Sized Increments）**
...
### 摄像机视锥体覆盖的场景区域 Z 轴范围的大小影响级联区间的划分
...
## 硬阴影（Hard Shadows）与软阴影（Soft Shadows）
...
- https://docs.google.com/presentation/d/10FKu5BF7HPC8hRKp1h3ZdO1tkUXagOq3ZLpHgJvDIqg/pub
- https://docs.unity3d.com/2021.3/Documentation/Manual/ShadowPerformance.html
- https://github.com/walbourn/directx-sdk-samples/blob/main/CascadedShadowMaps11
...
- https://developer.download.nvidia.cn/assets/gamedev/docs/GDC01_Shadows.pdf
