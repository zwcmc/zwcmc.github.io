...
layout: post
title:  "URP杂记"
date:   2024-03-13 16:16:00 +800
category: Unity
---

- [1. 说明](#1-说明)
- [2. ScriptableCullingParameters.conservativeEnclosingSphere](#2-scriptablecullingparametersconservativeenclosingsphere)
- [3. RenderBufferLoadAction](#3-renderbufferloadaction)
- [4. LUT(Look Up Table) for Color Grading in URP](#4-lutlook-up-table-for-color-grading-in-urp)
  - [4.1. 总结](#41-总结)
  - [4.2. 是否开启HDR渲染的差别](#42-是否开启hdr渲染的差别)
- [5. Distance Attenuation and Spot Angle Attenuation in URP](#5-distance-attenuation-and-spot-angle-attenuation-in-urp)
  - [5.1 Distance Attenuation](#51-distance-attenuation)
  - [5.2. Spot Angle Attenuation](#52-spot-angle-attenuation)
  - [5.3. 参考](#53-参考)
- [6. 关于聚光灯光源一点小误解](#6-关于聚光灯光源一点小误解)

## 1. 说明

学习Unity、URP、HDRP的笔记

## 2. ScriptableCullingParameters.conservativeEnclosingSphere
...
## 4. LUT(Look Up Table) for Color Grading in URP
...
## 5. Distance Attenuation and Spot Angle Attenuation in URP
